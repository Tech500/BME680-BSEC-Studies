...
void loop()
{
    ...
    else if((MINUTE % 30 == 0) || (MINUTE % 2 == 0) && (SECOND == 0))  //data point every 2 minutes
    {
        ...
        if(dataPoint == 15)  //Allow BME680 to heat 30 Minutes --default dataPoint == 15
        {
